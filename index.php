<?php
$mirror = "gayuus.com";		// Change this value to the site you want to mirror.
$source_ip = "204.232.175.78";          // This is the source ip of the site
...
$fp = fsockopen($source_ip, 80, $errno, $errmsg, 30);
if (!$fp) {
